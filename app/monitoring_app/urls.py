...
from monitoring_app.api.competitor_products_api import api_productcompetitor_id, api_productcompetitor
from monitoring_app.api.my_products_api import api_productmy_id, api_productmy
from monitoring_app.api.match_api import api_match_id, api_match
